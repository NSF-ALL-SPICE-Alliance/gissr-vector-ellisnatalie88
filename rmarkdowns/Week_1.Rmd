...
ggplot(data=world) +
  ...
  xlab("Longitude") + ylab("Latitude") +
  ggtitle("World Map", subtitle = "Created by Ellis Natalie")
```
...
```{r}
ggplot(data=world_without_australia) +
  geom_sf(aes(fill = pop_est)) +
    scale_fill_viridis_c(option = "plasma", trans = "sqrt") +
  xlab("Longitude") + ylab("Latitude") +
  ggtitle("World Map (without Australia)", subtitle = "~ Created by Ellis Natalie~")
```
...
ggplot(data=world_without_australia) +
  geom_sf(aes(fill = pop_est)) +
  coord_sf(crs = "+proj=ortho +lat_0=6.9147 +lon_0=107.6098 ") +
    scale_fill_viridis_c(option = "plasma", trans = "sqrt") +
  xlab("Longitude") + ylab("Latitude") +
  ggtitle("*Bandung, Indonesia* as the Center of the World", subtitle = "~ Created by Ellis Natalie~") +
