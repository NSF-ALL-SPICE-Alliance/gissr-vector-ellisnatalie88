...
#Kindly refer to Challenge 3 codes
...
ggplot(data=world)+
  ...
  geom_sf(aes(fill="Hawaii"))+
  coord_sf(xlim=c(-160.5,-154.5),ylim=c(18.5,22.5), expand = FALSE)+
  ggtitle("Map of Hawaii, United States")+
...
ggplot(data=world)+
  geom_sf(data = us_states)+
  geom_sf(data=lakes50,fill = "darkblue", color = "red")+
  geom_sf(data = rivers50, color = "lightblue", size = 0.15)+
  geom_sf(aes(fill="Hawaii"),size = 5)+
  coord_sf(xlim=c(-160.5,-154.5),ylim=c(18.5,22.5), expand = FALSE)+
  ggtitle("Map of Hawaii, United States")+
  annotation_scale(location = "bl", width_hint = 0.5) +
    annotation_north_arrow(location = "bl", which_north = "true", 
